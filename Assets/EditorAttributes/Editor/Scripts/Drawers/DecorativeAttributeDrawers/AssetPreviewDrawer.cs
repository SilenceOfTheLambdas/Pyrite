...
namespace EditorAttributes.Editor
{
    ...
    public class AssetPreviewDrawer : PropertyDrawerBase
    {
        ...
        private async void GetAssetPreview(SerializedProperty property, AssetPreviewAttribute assetPreviewAttribute,
            VisualElement root, Image image)
        {
            ...
            else
            {
                ...
                for (var i = 0; i < 2; i++)
                {
                    ...
                    await Task.Delay(EditorAttributesSettings.instance
                        .assetPreviewLoadTime); // Give time for the asset preview to load since is doing it asynchronously under the hood
                }
