    ...
    public abstract class CollectionDisplayDrawer : PropertyDrawerBase
    {
        ...
        protected virtual DropdownField CreateDropdownField(List<string> choices, SerializedProperty property)
        {
            DropdownField dropdownField = IsCollectionValid(choices)
                ? new DropdownField(property.displayName, choices, SetDropdownDefaultValue(choices, property))
        ...
        /// <param name="dropdownField">The dropdown field</param>
        protected virtual void SetDropdownValueFromProperty(SerializedProperty trackedProperty,
        ...
        protected List<string> GetDisplayValues(MemberInfo collectionInfo, IDisplayNamesAttribute displayNamesAttribute,
        ...
        protected bool IsCollectionDictionary(MemberInfo collectionInfo, SerializedProperty serializedProperty,
