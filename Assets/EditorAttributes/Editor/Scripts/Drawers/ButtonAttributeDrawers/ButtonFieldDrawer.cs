...
namespace EditorAttributes.Editor
{
    ...
    public class ButtonFieldDrawer : PropertyDrawerBase
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            if (function == null)
                return new HelpBox($"Could not find function <b>{buttonFieldAttribute.FunctionName}</b>",
                ...
                RepeatButton repeatButton =
                    new(
                        () => InvokeFunctionOnAllTargets(property.serializedObject.targetObjects, function.Name,
                            makeTargetsDirty: buttonFieldAttribute.MakeDirty), buttonFieldAttribute.PressDelay,
            ...
            {
                return new Button(() => InvokeFunctionOnAllTargets(property.serializedObject.targetObjects,
                    function.Name, makeTargetsDirty: buttonFieldAttribute.MakeDirty))
                {
                    text = buttonLabel,
                    tooltip = property.tooltip,
                    style = { height = buttonFieldAttribute.ButtonHeight }
