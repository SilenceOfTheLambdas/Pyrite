...
namespace EditorAttributes
{
    ...
    public class UnitFieldAttribute : PropertyAttribute
    {
        ...
        public UnitFieldAttribute(Unit displayUnit, Unit conversionUnit) : this(displayUnit.ToString(),
            conversionUnit.ToString())
        {
        }
        ...
        /// <param name="conversionUnit">The unit to convert to</param>
        public UnitFieldAttribute(string customDisplayUnit, Unit conversionUnit) : this(customDisplayUnit,
            conversionUnit.ToString())
        {
        }
        ...
        public UnitFieldAttribute(Unit displayUnit, string customConversionUnit) : this(displayUnit.ToString(),
            customConversionUnit)
        {
        }
