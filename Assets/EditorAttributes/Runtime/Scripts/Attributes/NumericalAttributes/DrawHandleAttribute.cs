...
namespace EditorAttributes
{
    ...
    public class DrawHandleAttribute : PropertyAttribute, IColorAttribute
    {
        ...
        /// <param name="handleSpace">In which coordinate space to place the handle</param>
        public DrawHandleAttribute(float r, float g, float b, Space handleSpace = Space.World) : this(GUIColor.Default,
            handleSpace)
        {
            UseRGB = true;
            R = r;
        ...
        /// <param name="handleSpace">In which coordinate space to place the handle</param>
        public DrawHandleAttribute(string hexColor, Space handleSpace = Space.World) : this(GUIColor.Default,
            handleSpace)
        {
            HexColor = hexColor;
        }
