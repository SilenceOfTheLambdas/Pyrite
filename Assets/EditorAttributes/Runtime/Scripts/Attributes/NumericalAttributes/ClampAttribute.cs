...
namespace EditorAttributes
{
    ...
    public class ClampAttribute : PropertyAttribute, IMinMaxAxisValueAttribute
    {
        ...
        public ClampAttribute(float minValueX, float maxValueX, float minValueY, float maxValueY) : this(minValueX,
            maxValueX, minValueY, maxValueY, minValueX, maxValueX)
        {
        }
        ...
        public ClampAttribute(float minValueX, float maxValueX, float minValueY, float maxValueY, float minValueZ,
            float maxValueZ) : this(minValueX, maxValueX, minValueY, maxValueY, minValueZ, maxValueZ, minValueX,
            maxValueX)
        {
        }
