...
namespace EditorAttributes
{
    ...
    public class LineAttribute : PropertyAttribute, IColorAttribute
    {
        ...
        /// <param name="alpha">Alpha amount</param>
        /// <param name="lineThickness">The thickness of the line in pixels</param>
        public LineAttribute(float red, float green, float blue, float alpha = 1f, float lineThickness = 3f) : this(
            GUIColor.Default, alpha, lineThickness)
        {
            UseRGB = true;
            R = red;
            G = green;
        ...
        /// <param name="alpha">Alpha amount</param>
        /// <param name="lineThickness">The thickness of the line in pixels</param>
        public LineAttribute(string hexColor, float alpha = 1f, float lineThickness = 3f) : this(GUIColor.Default,
            alpha, lineThickness)
        {
            HexColor = hexColor;
        }
