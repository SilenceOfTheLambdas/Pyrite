...
namespace EditorAttributes
{
    ...
    public class RequiredAttribute : PropertyAttribute
    {
        ...
        public RequiredAttribute(bool throwValidationError = false, bool buildKiller = false,
        ...
        /// <param name="throwValidationError">Throws an error in the console if validation fails</param>
        /// <param name="buildKiller">Throws an error during build time and cancels it if validation fails (unless build validation is disabled in the project settings)</param>
        public RequiredAttribute(string customFixFunctionName, bool throwValidationError = false,
            bool buildKiller = false) : this(throwValidationError, buildKiller, ReferenceFixMode.Custom)
        {
