    ...
    public class Glitch : ScriptableRendererFeature
    {
        ...
        private class GlitchRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor =
                    UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_GlitchColorCopy",
                        false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("Glitch_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("Glitch_MainPass", out var passData,
                           profilingSampler))
                {
