        ...
        private class SobelOutlineRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_SobelOutlineColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("SobelOutline_CopyColor",
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("SobelOutline_MainPass",
                           out var passData, profilingSampler))
                {
