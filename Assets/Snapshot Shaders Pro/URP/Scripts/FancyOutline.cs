        ...
        private class FancyOutlineRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_FancyOutlineColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("FancyOutline_CopyColor",
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("FancyOutline_MainPass",
                           out var passData, profilingSampler))
                {
