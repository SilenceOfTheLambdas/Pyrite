        ...
        private class FilmBarsRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_FilmBarsColorCopy", false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("FilmBars_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("FilmBars_MainPass", out var passData,
                           profilingSampler))
                {
