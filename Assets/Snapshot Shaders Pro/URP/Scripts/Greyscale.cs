    ...
    public class Greyscale : ScriptableRendererFeature
    {
        ...
        private class GreyscaleRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("Greyscale_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("Greyscale_MainPass", out var passData,
                           profilingSampler))
                {
