    ...
    public class Invert : ScriptableRendererFeature
    {
        ...
        private class InvertRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor =
                    UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_InvertColorCopy",
                        false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("Invert_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("Invert_MainPass", out var passData,
                           profilingSampler))
                {
