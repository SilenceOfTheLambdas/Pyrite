        ...
        private class BasicDitherRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_BasicDitherColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("BasicDither_CopyColor",
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("BasicDither_MainPass", out var passData,
                           profilingSampler))
                {
