        ...
        private class BarrelDistortionRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_BarrelDistortionColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("BarrelDistortion_CopyColor",
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("BarrelDistortion_MainPass",
                           out var passData, profilingSampler))
                {
