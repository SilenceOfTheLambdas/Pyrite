        ...
        private class ScanlinesRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_ScanlinesColorCopy", false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("Scanlines_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("Scanlines_MainPass", out var passData,
                           profilingSampler))
                {
