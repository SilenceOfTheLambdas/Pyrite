        ...
        private class FancyDitherRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_FancyDitherColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("FancyDither_CopyColor",
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("FancyDither_MainPass", out var passData,
                           profilingSampler))
                {
