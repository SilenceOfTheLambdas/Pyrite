        ...
        private class PosterizeRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_PosterizeColorCopy", false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("Posterize_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("Posterize_MainPass", out var passData,
                           profilingSampler))
                {
