namespace SnapshotShaders.URP
{
    ...
    public sealed class GameBoySettings : VolumeComponent, IPostProcessComponent
    {
        ...
        [Tooltip("Darkest colour.")] public ColorParameter darkestColor = new(new Color(0.11f, 0.21f, 0.08f));

        [Tooltip("Second darkest colour.")] public ColorParameter darkColor = new(new Color(0.24f, 0.38f, 0.21f));

        [Tooltip("Second lightest colour.")] public ColorParameter lightColor = new(new Color(0.57f, 0.67f, 0.21f));

        [Tooltip("Lightest colour.")] public ColorParameter lightestColor = new(new Color(0.75f, 0.82f, 0.46f));
