namespace SnapshotShaders.URP
{
    ...
    public sealed class FancyNeonSettings : VolumeComponent, IPostProcessComponent
    {
        ...
        public ClampedFloatParameter saturationFloor = new(0.75f, 0.0f, 1.0f);

        [Tooltip("Lightness/value values lower than this will be clamped to this.")]
        public ClampedFloatParameter lightnessFloor = new(0.75f, 0.0f, 1.0f);
        ...
        public ColorParameter emissiveEdgeColor = new(Color.white, true, true, true);
