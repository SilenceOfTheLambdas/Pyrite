        ...
        private class SynthwaveRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_SynthwaveColorCopy", false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("Synthwave_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("Synthwave_MainPass", out var passData,
                           profilingSampler))
                {
