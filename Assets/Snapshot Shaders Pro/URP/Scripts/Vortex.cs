    ...
    public class Vortex : ScriptableRendererFeature
    {
        ...
        private class VortexRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor =
                    UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_VortexColorCopy",
                        false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("Vortex_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("Vortex_MainPass", out var passData,
                           profilingSampler))
                {
