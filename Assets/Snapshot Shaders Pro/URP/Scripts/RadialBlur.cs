        ...
        private class RadialBlurRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor,
                    "_RadialBlurColorCopy", false);

                using (var builder =
                       renderGraph.AddRasterRenderPass<CopyPassData>("RadialBlur_CopyColor", out var passData,
                           profilingSampler))
                {
                ...
                using (var builder =
                       renderGraph.AddRasterRenderPass<MainPassData>("RadialBlur_MainPass", out var passData,
                           profilingSampler))
                {
