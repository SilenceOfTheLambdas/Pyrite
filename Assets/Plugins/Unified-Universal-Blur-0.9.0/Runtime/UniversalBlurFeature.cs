...
namespace Unified.UniversalBlur.Runtime
{
    ...
    {
        [Header("Blur Settings")] [Range(1, 12)] [SerializeField]
        private int iterations = 4;

        [Range(1f, 10f)] [SerializeField] private float downsample = 2.0f;

        [Tooltip("Enable mipmaps for more efficient blur")] [SerializeField]
        ...
        [Space] [Header("Advanced Settings")] [SerializeField]
        ...
        [SerializeField] [HideInInspector] [Reload("Shaders/Blur.shader")]
        ...
        private BlurConfig GetBlurConfig(in RenderingData renderingData)
        {
            ...
            var graphicsFormat =
                renderingData.cameraData.isHdrEnabled && descriptor.graphicsFormat != GraphicsFormat.None
